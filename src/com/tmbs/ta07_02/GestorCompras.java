...
/**
 * Esta clase contiene la l�gica de negocio del nuestra App seg�n las directrices del Ejercicio
 */
public class GestorCompras {

	// Declaramos Un ArrayList "Carrito" de productos donde a�adiremos los Productos comprados
	...
	/**
	 * M�todo para pedir los datos de una compra al usuario. El m�todo solicita el
	...
	/**
	 * M�todo que muestra un texto en la consola y espera a recibir una entrada del
	 * usuario.
	 * 
	 * @param {@text String} el texto que se mostrar� en la consola.
